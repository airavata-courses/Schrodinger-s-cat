...
function MyDetailsdetails(props){
    if(sessionStorage.getItem('myDetails') !== null){
        var retrieveduserDetails = JSON.parse(sessionStorage.getItem('myDetails')) ;
